...
private:
	vk::FramebufferCreateInfo buildFramebufferCreateInfo(const vk::RenderPass& vulkanRenderPass, const std::vector<vk::ImageView>& attachments, const vk::Extent2D& swapChainExtent) const;
