...
LogicalDevice::LogicalDevice(const vk::PhysicalDevice& vulkanPhysicalDevice, const std::optional<uint32_t>& graphicsFamilyIndex, uint32_t enabledLayerCount, const char* const* enabledLayerNames)
{
